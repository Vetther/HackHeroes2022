...
const SidebarBody = () => {
  ...
  return (
    <div className='sticky top-0 flex flex-col lg:w-1/6 h-screen bg-base-100 border border-base-300'>
        <div className='flex flex-wrap p-6 mb-5'>
            <Link href={"/"}><a className="font-bold xl:text-2xl text-xl text-primary">CitizenHub.pl</a></Link>
            <label className="swap swap-rotate 2xl:ml-3">
